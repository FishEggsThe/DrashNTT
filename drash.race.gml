...
#define init
	...
	global.spr_ult_icon[2] = sprite_add("drash/drashultrahudb.png", 1, 8, 9);
	 ...
	 // Sound:
	global.snd_slctDrash = sound_add("Sound/snd_ui_menuMoveBig.ogg");
	global.snd_cnfmDrash = sound_add("Sound/snd_ui_menuSelect.ogg");
	global.snd_wrldDrash = sound_add("Sound/snd_npc_player_drash_vo_tumble01.ogg");
	global.snd_hurtDrash = sound_add("Sound/snd_npc_player_drash_vo_hurt01.ogg");
	global.snd_deadDrash = sound_add("Sound/snd_npc_player_drash_vo_death01.ogg");
	global.snd_lowaDrash = sound_add("Sound/snd_npc_player_drash_vo_hurt03.ogg");
	global.snd_lowhDrash = sound_add("Sound/snd_npc_player_drash_vo_hurt02.ogg");
	global.snd_chstDrash = sound_add("Sound/snd_pickupPower_rare01.ogg");
	global.snd_valtDrash = sound_add("Sound/snd_npc_player_drash_vo_stun01.ogg");
	global.snd_crwnDrash = sound_add("Sound/snd_pickupPower_ultraRare01.ogg");
	global.snd_spchDrash = sound_add("Sound/msc_win_screen_intro.ogg");
	//global.snd_idpdDrash = sndMutant10IDPD;
	//global.snd_cptnDrash = sndMutant10Cptn;
	global.snd_dodgeOneDrash = sound_add("Sound/snd_npc_player_drash_vo_dodge01.ogg");
	global.snd_dodgeTwoDrash = sound_add("Sound/snd_npc_player_drash_vo_dodge02.ogg");
	global.snd_dodgeThrDrash = sound_add("Sound/snd_npc_player_drash_vo_dodge03.ogg");
	...
	while(true){
		...
		for(var i = 0; i < maxp; i++){
			...
			if(_race[i] != r && r = "drash"){
				sound_play(global.snd_slctDrash); // Select Sound
			}
			_race[i] = r;
		}
...
#define level_start
 ...
 // On Run Start:
#define game_start
	sound_play(global.snd_cnfmDrash); // Play Confirm Sound
...
#define create
	...
	spr_sit2 = global.spr_sit2[bskin];
	 ...
	 // Set Sounds:
	snd_wrld = global.snd_wrldDrash;	// FLÄSHYN
	snd_hurt = global.snd_hurtDrash;	// THE WIND HURTS
	snd_dead = global.snd_deadDrash;	// THE STRUGGLE CONTINUES
	snd_lowa = global.snd_lowaDrash;	// ALWAYS KEEP ONE EYE ON YOUR AMMO
	snd_lowh = global.snd_lowhDrash;	// THIS ISN'T GOING TO END WELL
	snd_chst = global.snd_chstDrash;	// TRY NOT OPENING WEAPON CHESTS
	snd_valt = global.snd_valtDrash;	// AWWW YES
	snd_crwn = global.snd_crwnDrash;	// CROWNS ARE LOYAL
	snd_spch = global.snd_spchDrash;	// YOU REACHED THE NUCLEAR THRONE
	snd_idpd = global.snd_valtDrash;	// BEYOND THE PORTAL
	snd_cptn = global.snd_spchDrash;	// THE STRUGGLE IS OVER
...
#define step
	...
	if(canspec){
		...
		if(button_pressed(index, "spec") && !airbourne){
			...
			sound_play(choose(global.snd_dodgeOneDrash, global.snd_dodgeTwoDrash, global.snd_dodgeThrDrash));
			canStomp = true;
